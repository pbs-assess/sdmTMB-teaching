...
* Ideal world
  * Plug spatial coviariates into a GLM / GLMM
...
* Need wiggly / smooth surface for approximating spatial complexity
...
* High dimensional datasets are computationally challenging
  * Too many random effects if we try to estimate value at observations
...
fit1 <- gam(y ~ s(x, bs = "gp", k = 25), data = df)
