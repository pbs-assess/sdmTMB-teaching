...
.small[
```{r proj-plot, echo=TRUE, eval=TRUE}
puso <- readRDS("data/puso.rds")
...
```{r barrier, echo=TRUE, eval=FALSE}
...
```{r plot-barrier, echo=FALSE, eval=FALSE}
