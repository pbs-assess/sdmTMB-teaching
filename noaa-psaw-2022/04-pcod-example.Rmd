...
.small[
```{r, echo=TRUE, out.width="600px", fig.width=6}
...
index_sims <- get_index_sims(psims, area = rep(4, nrow(p_sims))) #<<
...
.small[
```{r pcod-st-cog, echo=TRUE, fig.width=6, fig.asp=0.5, out.width="600px"}
