...
plotdir <- here('exercises','garn-ruse-ex','plots','biomass-depth')
resdir <- here('exercises','garn-ruse-ex','results','biomass-depth')
...
# 1            base       TRUE       10     FALSE       1 -1.517698 -3503.633     0.078      87.693
# 2    base_spatial       TRUE       10     FALSE       1 -1.441469 -3415.940     0.002       0.000
# 3 base_spatial_st       TRUE       10     FALSE       0 -1.439800 -3424.114     0.000       8.174
# 4     base_siteRE       TRUE       10     FALSE       0 -1.440462 -3421.840     0.001       5.900
# 5        base_lat       TRUE       10     FALSE       4 -1.510344 -3496.719     0.071      80.779
# 6  base_latsmooth       TRUE       10     FALSE       2 -1.495147 -3476.798     0.055      60.858
# 7   base_2dsmooth       TRUE       10     FALSE       2 -1.463457 -3448.617     0.024      32.677
...
Random effect parameters:
  ...
  png(file.path(plotdir, paste0('effect_depth_m',mods[m],'.png')), units='in', width=5, height=5, res=150)
  print(visreg::visreg(fits_full[[m]], xvar = "depth", scale='response', gg=T, rug=F, xlab='Year', ylab='Biomass (kg)') + theme_bw())
  dev.off()
