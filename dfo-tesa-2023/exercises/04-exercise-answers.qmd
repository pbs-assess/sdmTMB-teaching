...
4.  What is a simpler random field structure you could try? Try that below with `fit_ye1`.
3.  What is a simpler family you could try? Try that below with `fit_ye2`.
