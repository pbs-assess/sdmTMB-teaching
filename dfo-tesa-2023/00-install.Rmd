...
**As of January 11, only the macOS binary version is ready. If on Windows, wait another day or two or go the slower route of clicking 'yes' to the button that pops up asking if you want to install from source. This should work assuming you installed Rtools 4.2 above.**
