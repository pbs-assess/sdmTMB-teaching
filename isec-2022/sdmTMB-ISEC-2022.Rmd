...
# sdmTMB: an R package for fast, flexible, and accessible generalized linear mixed effects models with spatial and spatiotemporal random fields
...
.small[
Widely applicable to species distribution modelling (**sdm**TMB) or most geostatistical data
]
